        ...
        <div class="panel panel-default" id="panel">
            <div class="panel-body">
                <div style="margin-top: 1rem">
                    <a style="border-radius:5px;background-image: linear-gradient(#D60000, #ee5046);color:#FFF;padding: 0.5rem 1rem;margin-top: 1rem;margin-bottom: 1rem;font-size:1.05rem" href="{{route('customer.getOrderStatus',['prepared'])}}">سفارشات
                        آماده شده</a>
                    <a style="border-radius:5px;background-image: linear-gradient(#D60000, #ee5046);color:#FFF;padding: 0.5rem 1rem;margin-top: 1rem;margin-bottom: 1rem;font-size:1.05rem" href="{{route('customer.getOrderStatus',['doing'])}}">سفارشات
                        در حال انجام</a>
                </div>
