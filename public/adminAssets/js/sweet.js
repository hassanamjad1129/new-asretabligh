...
$('.newAnswer').click(function () {
    var newAnswer = '<div class="col-md-12">\n' + '                        <i class="fa fa-times-circle fa-2x text-danger closeAnswer" style="cursor: pointer"></i>\n' + '                        <label for="">عنوان پاسخ خود را وارد کنید</label>\n' + '                        <textarea name="answer[]" id="" cols="30" rows="10"></textarea>\n' + '                        <div class="col-md-6">\n' + '                            <label for="">مقیاس پاسخ</label>\n' + '                            <select name="answer_category[' + $("select[name^='answer_category[']").length + '][]" id="" style="overflow-y: scroll;" multiple class="form-control">\n' + $("select[name=category]").html() + '                            </select>\n' + '                        </div>\n' + '                        <div class="col-md-6">\n' + '                            <label for="">امتیاز پاسخ</label>\n' + '                            <input type="number" name="score[]" id="" class="form-control">\n' + '                        </div>\n' + '                    <div class="clearfix"></div><hr></div>';
    $('.answers').append(newAnswer);
    tinymce.init(editor_config);
});
$("select[name=category]").change(function () {
    if ($(this).val() !== 'None') $("select[name='answer_category[]']").val($(this).val());
});
$("#createFile").click(function () {
    var file = "<div class='col-md-6' style='padding: 10px'>" + "<input type='file' name='file[]' accept='image/*,audio/*,video/*' class='form-control' />" + "</div>";
    $("#files").append(file);
});
